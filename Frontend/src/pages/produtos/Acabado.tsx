...
export default function Acabado() {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    schema?.fields.forEach((field) => {
      ...
      if (field.name === "tempo_producao" && selectedTipo !== "Acabado") return;
      if (field.name === "preco_compra" && selectedTipo === "Acabado") return;
  ...
  const tableColumns = React.useMemo<ColumnDef<any>[]>(() => {
    ...
    const ocultas = ["armazem_nome","stock_atual", "preco_compra"];
    if (schema) {
        schema.columns
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Modal
        ...
        title={
          currentRecord ? "Editar Registo" : `Novo Registo em Produtos ${activeTab}`
        }
        footer={
          <>
      ...
      >
        {schema && (
          ...
          >
            ...
            <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden mb-2">
